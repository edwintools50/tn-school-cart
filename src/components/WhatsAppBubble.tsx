...
export default function WhatsAppBubble() {
  ...
  return (
    <a
      ...
      className="fixed bottom-28 right-5 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-105 sm:bottom-5"
    >
      <svg
        viewBox="0 0 32 32"
        aria-hidden="true"
